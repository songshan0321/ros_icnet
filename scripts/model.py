...
from visualize import decode_labels
...
class ICNet_BN(Network):
    def __init__(self, cfg, mode, image_reader=None):
        ...
        if mode == 'train':
            ...
            super(ICNet_BN, self).__init__(inputs={'data': self.images}, cfg=self.cfg)
            ...
            self.images, self.o_shape, self.n_shape = _infer_preprocess(self.img_placeholder, self.cfg.param['infer_size'])
